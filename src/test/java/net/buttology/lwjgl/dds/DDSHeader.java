...
//	public static final int		DDS_FLAGS_VOLUME			= DDSCAPS2_VOLUME;
    ...
    public boolean isHasFlagMipMapCount() {
        return hasFlagMipMapCount;
    }

    public boolean isHasFlagCaps() {
        return hasFlagCaps;
    }

    public boolean isHasFlagHeight() {
        return hasFlagHeight;
    }

    public boolean isHasFlagWidth() {
        return hasFlagWidth;
    }

    public boolean isHasFlagPitch() {
        return hasFlagPitch;
    }

    public boolean isHasFlagPixelFormat() {
        return hasFlagPixelFormat;
    }

    public boolean isHasFlagLinearSize() {
        return hasFlagLinearSize;
    }

    public boolean isHasFlagDepth() {
        return hasFlagDepth;
    }

    public boolean isHasCapsComplex() {
        return hasCapsComplex;
    }

    public boolean isHasCapsMipMap() {
        return hasCapsMipMap;
    }

    public boolean isHasCapsTexture() {
        return hasCapsTexture;
    }

    public boolean isHasCaps2CubeMap() {
        return hasCaps2CubeMap;
    }

    public boolean isHasCaps2CubeMapPX() {
        return hasCaps2CubeMapPX;
    }

    public boolean isHasCaps2CubeMapNX() {
        return hasCaps2CubeMapNX;
    }

    public boolean isHasCaps2CubeMapPY() {
        return hasCaps2CubeMapPY;
    }

    public boolean isHasCaps2CubeMapNY() {
        return hasCaps2CubeMapNY;
    }

    public boolean isHasCaps2CubeMapPZ() {
        return hasCaps2CubeMapPZ;
    }

    public boolean isHasCaps2CubeMapNZ() {
        return hasCaps2CubeMapNZ;
    }

    public boolean isHasCaps2Volume() {
        return hasCaps2Volume;
    }
}