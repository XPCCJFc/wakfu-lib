...
public interface IColormap {
	 ...
	 */
	boolean colorize(byte[] data, final long currentOffset);
	 ...
	 */
	Color getBackgroundColor(byte[] data, final long currentOffset);
	 ...
	 */
	Color getForegroundColor(byte[] data, final long currentOffset);
}
