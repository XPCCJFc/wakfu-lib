 ...
 */
public class JCaret //FIXME remplacer par un vrai DefaultCarret => support du mode Inser/Replace ex:http://java-sl.com/tip_overwrite_mode.html
{
	/**
	 ...
	 * @throws NullPointerException Thrown if the color is null.
	 */
	public JCaret(int blinkPeriod, final Color caretColor)
	{
	...
	{
		for (ICaretListener listener : m_listeners)
		{
	 ...
	 */
	public void draw(Graphics g, final int x, final int y, final int height)
	{
