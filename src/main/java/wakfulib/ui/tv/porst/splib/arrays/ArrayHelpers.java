package wakfulib.ui.tv.porst.splib.arrays;
...
public final class ArrayHelpers {
	 ...
	 */
	public static byte[] getSubArray(byte[] source, final int offset, final int length) {
	 ...
	 */
	public static byte[] removeData(byte[] data, final int startOffset, final int length) {
	 ...
	 */
	public static byte[] replaceData(byte[] data, final int startOffset, final int length, final byte replacementValue) {
