...
public final class BinaryParserHelpers {
	 ...
	 */
	public static boolean hasBitsLeft(BinaryParser parser, final long numberOfBits) {
	 ...
	 */
	public static boolean hasBytesLeft(BinaryParser parser, final long numberOfBytes) {
	 ...
	 */
	public static byte[] readByteArray(BinaryParser parser, final int length) {
