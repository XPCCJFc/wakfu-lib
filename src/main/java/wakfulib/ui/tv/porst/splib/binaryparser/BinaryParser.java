...
public class BinaryParser {
	 ...
	 */
	public UBits peekBits(int numberOfBits) {
	 ...
	 */
	public UBits readBits(int numberOfBits) {
	 ...
	 */
	public Bits readSBits(int numberOfBits) {
	 ...
	 * @return The read string.
	 */
	public AsciiString readString(int numberOfBytes) {
	 ...
	 */
	public void setPosition(int bytePosition, final int bitPosition) {
