...
public class TextLineNumber extends JPanel
     ...
     * </ul>
     * @param digitAlignment the alignement
     */
    public void setDigitAlignment(@MagicConstant(valuesFromClass = TextLineNumber.class) float digitAlignment) {
        this.digitAlignment =
    ...
    /*
     *	Get the line number to be drawn. -1 will be returned
