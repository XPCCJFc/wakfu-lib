...
public class JScrollPopupMenu extends JPopupMenu {
    ...
    public JScrollPopupMenu(@Nullable String label) {
        super(label);
    ...
    public void installOn(JMenu menu) {
        try {
            var popupMenu = JMenu.class.getDeclaredField("popupMenu");
            popupMenu.setAccessible(true);
            popupMenu.set(menu, this);
            this.setInvoker(menu);
            var createWinListener = JMenu.class.getDeclaredMethod("createWinListener", JPopupMenu.class);
            createWinListener.setAccessible(true);
            createWinListener.invoke(menu, this);
        } catch (Exception e) {
            new ExceptionDialog("Error while installing menu fix", e).setVisible(this);
        }
    }
}
